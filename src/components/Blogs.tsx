...
const Blogs = ({ heading, image, text, link }: Props) => {
  return (
    <div className="     max-w-xs border-2 border-gray-600  h-auto ">
      <img
        src={image}
        alt=""
      ...
      <button className="flex   justify-center bg-blue-600 mx-24 w-24 mb-4 rounded-3xl py-2 hover:bg-blue-300 ">
